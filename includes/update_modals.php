 ...
 <div class="modal-body">
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group" id="form-login">
          ...
          <div class="col-sm-8">
          <input name="id" value='<?php echo $id; ?>' type='hidden'>
            <input class="form-control" style="text-transform:capitalize" id="" name="pos" type="text" value="<?php echo $row['production'] ?>" required>
          </div>
        </div>
        ...
        <div class="form-group" id="form-login">
          ...
          <div class="col-sm-8">
            ...
            <input class="form-control" style="text-align:right" id="" name="dr" type="number" value="<?php echo $row['product_type'] ?>" required>
          </div>
        </div>
    ...
    <div class="form-horizontal">
        ...
        <div class="form-group" id="form-login">
         ...
         <div class="form-group" id="form-login">
          ...
          <option value="3">Tracking</option>
          </select>
          </div>
        </div>
      <div class="form-group" id="form-login">
