...
<body>
            ...
            <div class="page-title-area" style="padding-top:20px; padding-bottom:0px;">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Request Section</h4>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                 ...
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add new request type</p>
                                        ...
                                        <a href="index.php?page=xleave-section" class="btn btn-sm btn-info">back</a>
                                    </div>
                                    </form>
                        </div>
                    </div>
