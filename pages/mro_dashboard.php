...
error_reporting(0);
    ...
    ?>
    <div style="font-size: 50px; text-align:center;"><i class='bx bxs-wrench'></i>Maintenance Repair and Overall</div>
        <hr>
      <div class="row">
        <div class="col-md-8">
        <div class="card card-outline card-success">
          <div class="card-header" style="font-size:20px">
            <b>Project Service Progress</b>
          </div>
              ...
              <table class="table m-0 table-hover">
                ...
                $row['status'] = 4;
                  ...
                  <tr>
                      ...
                      <td>
                        <a class="btn btn-primary btn-sm" href="../pages/mview_project.php">
...
<?php include '../includes/mrfooter.php' ?>