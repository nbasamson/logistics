...
?>
            ...
            <div class="card-header py-3">
              <center><h4 class="m-2 text-dark" style="font-size:50px; font-weight:bold">Product List&nbsp;<a  href="#" data-toggle="modal" data-target="#aModal" type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;"><i class='bx bx-cart-add' style="font-size:20px"></i></a></h4></center>
            </div>
            <div class="card-body">
                            ...
                            <div class="btn-group"> </td>
                                <td>
                                  <li style="list-style-type: none">
                                      <a type="button" class="btn btn-primary bg-gradient-primary" style="border-radius: 0px;" href="pro_edit.php?action=edit & id='.$row['PRODUCT_ID']. '">
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <center><h5 class="modal-title" id="exampleModalLabel" style="font-weight:bold; font-size:20px">Add Product</h5></center>
