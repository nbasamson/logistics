    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                <a class="navbar-brand" href=""><b>Premiere Agency</b></a>
            </div>
            <!-- Top Menu Items -->
...
$pages = array('home','position','employee','employee_profile','division','project_list','project_detail','progress','update_progress','user_list','attendance','project_team','product','pro_add','pro_edit','pro_transac', 'zitems', 'taskgroup', 'specification', 'inventory', 'transaction', 'supplier','pro_edit1','mro_dashboard' , 'mro_list', 'mro_add' , 'mro_reports', 'mro_worko','mview_project', 'employees','xdashboard','xemployees','xdepartment', 'xleave-section' , 'xmanage-admin', 'xpending-history', 'xapproved-history', 'xdeclined-history','xreq-history', 'xadd-employee.php', 'xadd-admin', 'xemployeeLeave-details' ,'zdashboard', 'zpurchase','zfacility','zdisposal','zvendor','zaccountability','zreports','xsupply-request');
  ...
  <div id="foreman_portfolio_report" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog"> 
               <div class="modal-content modal-md">  
                  ...
                  <div class="modal-header"> 
                     <h4 class="modal-title" id='head'>
                     <i class=""></i> Contractor Portfolio Records
                     </h4> 
                     <div id="retCode1"></div>
                  </div> 
