...
<div class="col-md-2">
	...
	<a class="col-sm-12 btn btn-md btn-info"  href="#new_employee" data-toggle="modal"><center><i class="fa fa-plus"></i>New Contractor</center></a>
</div>
<div id="retCode1"></div>
