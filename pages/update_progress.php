...
<div class="panel-body">
	...
	<div class="row">
		<div class="col-sm-4 text-right"><label class="control-label">Contractor:</label></div>
...
<div style="text-align: center",><a href="index.php?page=project_detail&id=5&stats=1" class="btn btn-sm btn-info"><i class='bx bx-arrow-back'></i> Back </a></div>
